...
axis(1, at=2:length(bar_names), labels=bar_names, las=2)
...
# Create a pie chart
pie(counts, labels = fruits, main = "Favorite Fruits")

# Add a legend
legend("topright", legend = fruits, fill = rainbow(length(fruits)))
